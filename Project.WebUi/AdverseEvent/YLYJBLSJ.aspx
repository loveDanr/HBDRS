<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YLYJBLSJ.aspx.cs" Inherits="Project.WebUi.AdverseEvent.YLYJBLSJ"  %>
...
<body>
    ...
    <asp:SqlDataSource ID="SqlDataSourceKS" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConnString %>"
        SelectCommand=" DECLARE @rootDeptID int ; SELECT  @rootDeptID = DeptId FROM Department WHERE ParentDeptID='0'; SELECT * FROM Department WHERE ParentDeptID=@rootDeptID;">
    </asp:SqlDataSource>
    ...
    <div id="sectionDIV2" class="header-section">
        <table class="custom">
            ...
            <tr>
                ...
                <td colspan="3" style="border: 2px solid #AECAF0;">
    ...
    <div id="sectionDIV5" class="header-section">
        <table class="custom">
            ...
            <tr>
                ...
                <td colspan="2" style="border: 2px solid #AECAF0;">
		        </td>
            </tr>
        </table>
    </div>
