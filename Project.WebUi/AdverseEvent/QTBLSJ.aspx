<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QTBLSJ.aspx.cs" Inherits="Project.WebUi.AdverseEvent.QTBLSJ"  %>
...
<body>
    ...
    <div id="sectionDIV0" class="header-section">
        <table class="custom">
            <tr>
                <td class="td_leftcol1" style="width: 295px">
                    其他不良事件名称
                </td>
                <td class="td_right" style="width: 354px">
                    <dx:ASPxTextBox ID="ASPxTextBoxEventName" runat="server" Width="70%">
            ...
            <tr>
                ...
                <td colspan="3" style="border: 2px solid #a1a7ab;">
                    <dx:ASPxComboBox ID="ASPxComboBoxEType" runat="server" Width="100%" DropDownStyle="DropDown">
                        <Items>
                            <dx:ListEditItem Text="医院信息系统故障" Value="医院信息系统故障" />
                            <dx:ListEditItem Text="病案及信息安全事件" Value="病案及信息安全事件" />
                            <dx:ListEditItem Text="食品安全事件" Value="食品安全事件" />
                            <dx:ListEditItem Text="危险品相关不良事件" Value="危险品相关不良事件" />
                        </Items>
                    </dx:ASPxComboBox>
                </td>
            </tr>
