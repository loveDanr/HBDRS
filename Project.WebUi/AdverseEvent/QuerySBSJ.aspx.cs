...
{
    public partial class QuerySBSJ : MyBasePage
    {
        ...
        protected void ASPxGridView1_BeforePerformDataSelect(object sender, EventArgs e)
        {
            ...
            {
                SqlDataSource1.SelectCommand = "SELECT * FROM [AE_ShareEventInfo] WHERE eventName = '医学装备不良事件' AND reportTime >= @startTime AND reportTime <= @endTime AND eventGrade LIKE @eventGrade  ORDER BY baseEventID";
            ...
            {
                SqlDataSource1.SelectCommand = "SELECT * FROM [AE_ShareEventInfo] WHERE eventName = '医学装备不良事件' AND reportTime >= @startTime AND reportTime <= @endTime  ORDER BY baseEventID ";
                SqlDataSource1.SelectParameters.Clear();
                SqlDataSource1.SelectParameters.Add("startTime", ASPxTimeEditStart.DateTime.ToString());
                SqlDataSource1.SelectParameters.Add("endTime", ASPxTimeEditEnd.DateTime.ToString());
            }
