...
{
    public partial class HLSYFY : MyBasePage
    {
        ...
        protected void cp_Callback(object sender, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            db.AddInParameter(dbEventcmd, "eventName", DbType.String, "护理不良事件-输液反应");
            ...
            string insertInfusionEvent = @"INSERT INTO [AE_InfusionEventInfo]
                                           ([baseEventID]
                                           ,[InPosition]
                                           ,[EventResult]
                                           ,[TYJLFY]
            ...
            DbCommand dbInfusionEventcmd = db.GetSqlStringCommand(insertInfusionEvent);
            db.AddInParameter(dbInfusionEventcmd, "baseEventID", DbType.String);
            ...
            using (oneConn = db.CreateConnection())
            {
                ...
                try
                {
                    ...
                    dbInfusionEventcmd.Parameters["@baseEventID"].Value = bEventID;
