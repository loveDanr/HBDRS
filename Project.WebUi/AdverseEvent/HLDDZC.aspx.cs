...
{
    public partial class HLDDZC : MyBasePage
    {
        ...
        protected void cp_Callback(object sender, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            db.AddInParameter(dbEventcmd, "eventName", DbType.String, "护理不良事件-"+ASPxComboBoxEType.Text);
            ...
            string insertFallEvent = @"INSERT INTO [AE_FallOfBedEventInfo]
                                       ([baseEventID]
                                       ,[BeforeConsciousState]
                                       ,[AfterConsciousState]
                                       ,[DDZCSHZZT]
                                       ,[SJDZYTSYX]
                                       ,[LJTZ]
            ...
            DbCommand dbFallEventcmd = db.GetSqlStringCommand(insertFallEvent);
            db.AddInParameter(dbFallEventcmd, "baseEventID", DbType.String);
            ...
            using (oneConn = db.CreateConnection())
            {
                ...
                try
                {
                    ...
                    dbFallEventcmd.Parameters["@baseEventID"].Value = bEventID;
