...
{
    public partial class EditYLYJ : MyBasePage
    {
        ...
        private void InitFromSql()
        {
            string selectSql = "BEGIN" +
                ...
                " SELECT [hospitalID],[patientName],[patientSex],[patientAge],[nationality],[jobTitle],[pClinicTime],[clinicalDiagonse] FROM AE_PatientInfo WHERE  baseEventID = @baseEventID;" +
            ...
            if (dr != null)
            {
                ...
                ASPxTimeEditClinic.Value = dr["pClinicTime"];
