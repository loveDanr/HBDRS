<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QueryYXSJ.aspx.cs" Inherits="Project.WebUi.AdverseEvent.QueryYXSJ"
     %>
...
<body>
    ...
    <div>
        ...
        <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1"
            ...
            <Columns>
                <dx:GridViewCommandColumn Caption="操作" ShowDeleteButton="True" ShowEditButton="true" VisibleIndex="0" Width="54px">
                ...
                <dx:GridViewDataTextColumn FieldName="patientName" VisibleIndex="13" Caption="患者姓名">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="hospitalID" Caption="住院号" VisibleIndex="14">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataDateColumn FieldName="reportTime" Caption="报告时间" VisibleIndex="15">
                    <Settings AllowAutoFilter="False" />
                </dx:GridViewDataDateColumn>
                ...
                <dx:GridViewDataComboBoxColumn Caption="事件等级" FieldName="eventGrade" VisibleIndex="12">
                    <Settings AllowHeaderFilter="True" />
