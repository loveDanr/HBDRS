...
{
    public partial class XZBLSJ : MyBasePage
    {
        ...
        {
            //SqlDataSourceParty.InsertParameters["baseEventID"].DefaultValue = bEventID.ToString();
            //SqlDataSourceParty.InsertParameters["dClinicalDept"].DefaultValue = e.NewValues["dClinicalDept"].ToString();
            //SqlDataSourceParty.InsertParameters["dPostCategory"].DefaultValue = e.NewValues["dPostCategory"].ToString();
            //SqlDataSourceParty.InsertParameters["dPersonCategory"].DefaultValue = e.NewValues["dPersonCategory"].ToString();
            //SqlDataSourceParty.InsertParameters["dTechCategory"].DefaultValue = e.NewValues["dTechCategory"].ToString();

            //SqlDataSourceParty.Insert();
            //e.Cancel = true;
        }
        ...
        protected void SqlDataSourceParty_Inserted(object sender, SqlDataSourceStatusEventArgs e)
        {

        }
        protected void SqlDataSourceParty_Updating(object sender, SqlDataSourceCommandEventArgs e)
        {
        ...
        protected void cp_Callback(object sender, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            db.AddInParameter(dbEventcmd, "eventName", DbType.String, "行政后勤不良事件");
