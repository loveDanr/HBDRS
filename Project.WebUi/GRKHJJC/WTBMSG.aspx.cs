...
{
    public partial class WTBMSG : Project.WebUi.App_Code.MyBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                else
                {
                    ...
                    ASPxGridViewMaster.ClientSideEvents.RowDblClick = null;
        ...
        protected void SqlDataSourceReport_Selected(object sender, SqlDataSourceStatusEventArgs e)
        {
