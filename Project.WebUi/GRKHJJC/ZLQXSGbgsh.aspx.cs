...
{
    public partial class ZLQXSGbgsh : Project.WebUi.App_Code.MyBasePage
    {
        ...
        protected void cp_Callback(object sender, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            string updateReport = @"UPDATE GRK_JYBG SET DeptID =@DeptID, Grade =@Grade,Means =@Means, LabSample =@LabSample, 
