<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MJQSG.aspx.cs" Inherits="Project.WebUi.GRKHJJC.MJQSG"  %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function grid_RowDblClick(s, e) {
            ...
            var nurl = "./MJQSGbgsh.aspx?id=" + key;
...
<body>
    ...
    <div>
        ...
        <dx:ASPxGridView ID="ASPxGridViewMaster" runat="server" AutoGenerateColumns="False" Width="100%"  ClientInstanceName="gridMaster"
            ...
            OnHeaderFilterFillItems="ASPxGridViewMaster_HeaderFilterFillItems" OnStartRowEditing="ASPxGridViewMaster_StartRowEditing" OnCellEditorInitialize="ASPxGridViewMaster_CellEditorInitialize">
            ...
            <Columns>
                ...
                <dx:GridViewDataHyperLinkColumn Caption="打印报告单" VisibleIndex="1" FieldName="ReportID">
                    <PropertiesHyperLinkEdit Text="打印报告单" NavigateUrlFormatString="MJQSGReport.aspx?id={0}"
                        Target="_blank">
                ...
                <dx:GridViewDataTextColumn Caption="标本" FieldName="LabSample" VisibleIndex="5" ReadOnly="true" >
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn Caption="灭菌器类型" FieldName="DisSteMis" VisibleIndex="3">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn Caption="灭菌时间" FieldName="KeepTime" ShowInCustomizationForm="True"
                    VisibleIndex="4">
                </dx:GridViewDataTextColumn>
                ...
                <DetailRow>
                    <dx:ASPxGridView ID="ASPxGridViewDetails" runat="server" AutoGenerateColumns="False" Width="100%" 
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn Caption="参考值" FieldName="Reference" VisibleIndex="3" Visible="False">
                            </dx:GridViewDataTextColumn>
                        </Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSourceReport" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConnString %>"
            SelectCommand="SELECT [ReportID], [DeptID], [DisSteMis], [LabSample], [KeepTime], [LabObject], [Transportor], [TransportDate], [Reportor], [ReportDate], [Checkor] FROM [GRK_JYBG] WHERE ReportCategory='MJQSG' AND TransportDate&gt;=@startDate AND TransportDate&lt;=@endDate "
            InsertCommand="INSERT INTO GRK_JYBG(DeptID, DisSteMis, LabSample, KeepTime, Transportor, TransportDate, Reportor, ReportDate, Checkor,ReportCategory,LabObject) VALUES (@DeptID,@DisSteMis,@LabSample,@KeepTime,@Transportor,@TransportDate,@Reportor,@ReportDate,@Checkor,'MJQSG','生物监测')"
            UpdateCommand="UPDATE GRK_JYBG SET DeptID =@DeptID, DisSteMis =@DisSteMis, LabSample =@LabSample, KeepTime =@KeepTime, Transportor =@Transportor, TransportDate =@TransportDate, Reportor =@Reportor, ReportDate =@ReportDate, Checkor =@Checkor WHERE ReportID = @ReportID"
