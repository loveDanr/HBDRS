<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HJWSSG.aspx.cs" Inherits="Project.WebUi.GRKHJJC.HJWSSG" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ddColseUp(s, e) {
            if (s.GetText().length < 2) {
                ...
                if (s.GetSelectedItem() != null) {
                    //s.SetValue(s.GetSelectedItem().GetColumnText("DeptId"));
        ...
        function grid_RowDblClick(s, e) {
            ...
            var nurl = "./HJWSSGbgsh.aspx?id=" + key;
...
<body>
    ...
    <div>
        ...
        <dx:ASPxGridView ID="ASPxGridViewMaster" runat="server" AutoGenerateColumns="False" Width="100%" 
            ...
            OnStartRowEditing="ASPxGridViewMaster_StartRowEditing" 
            onhtmlrowprepared="ASPxGridViewMaster_HtmlRowPrepared" 
            oncelleditorinitialize="ASPxGridViewMaster_CellEditorInitialize" 
            oninitnewrow="ASPxGridViewMaster_InitNewRow">
            <ClientSideEvents EndCallback="OnGridEndCallback" />
            <Columns>
                <dx:GridViewCommandColumn Caption="操作" VisibleIndex="0" ShowDeleteButton="True" ShowEditButton="True" ShowNewButtonInHeader="True">
                </dx:GridViewCommandColumn>
                <dx:GridViewDataHyperLinkColumn Caption="打印报告单" VisibleIndex="1" FieldName="ReportID">
                    <PropertiesHyperLinkEdit Text="打印报告单" NavigateUrlFormatString="HJWSSGReport.aspx?id={0}"
                        Target="_blank">
                ...
                <dx:GridViewDataComboBoxColumn Caption="环境类别" FieldName="Grade" VisibleIndex="3">
...
<%--            <SettingsDetail ShowDetailRow="True" />
                ...
                <DetailRow>
                    <dx:ASPxGridView ID="ASPxGridViewDetails" runat="server" AutoGenerateColumns="False" Width="100%" 
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataComboBoxColumn Caption="环境类别" FieldName="ItemGrade" VisibleIndex="1">
                                <PropertiesComboBox ValueType="System.String" CallbackPageSize="10" EnableCallbackMode="true"
        ...
        <asp:SqlDataSource ID="SqlDataSourceReport" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConnString %>"
            SelectCommand="SELECT [ReportID], [DeptID], [LabSite], [Grade], [LabSample], [LabObject], [Transportor], [TransportDate], [Reportor], [ReportDate], [Checkor] FROM [GRK_JYBG] WHERE ReportCategory='HJWSSG' AND TransportDate&gt;=@startDate AND TransportDate&lt;=@endDate "
            InsertCommand="INSERT INTO GRK_JYBG(DeptID, LabSite, Grade, LabSample, Transportor, TransportDate, Reportor, ReportDate, Checkor,ReportCategory) VALUES (@DeptID,@LabSite,@Grade,@LabSample,@Transportor,@TransportDate,@Reportor,@ReportDate,@Checkor,'HJWSSG')"
        ...
        <asp:SqlDataSource ID="SqlDataSourceJYItem" runat="server" ConnectionString="<%$ ConnectionStrings:LISConnectionString %>"
            SelectCommand="SELECT xmdh,xmmc,ISNULL(dyckz,'')+ISNULL(dw,'') AS zxbz FROM xm_info WHERE yq ='HJWSSG'">
        </asp:SqlDataSource>
