...
{
    public partial class HJWSSG :  Project.WebUi.App_Code.MyBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //((GridViewDataDateColumn)ASPxGridViewMaster.Columns["TransportDate"]).ReadOnly = true;
            }
        }
        ...
        //protected void ASPxGridViewMaster_HtmlDataCellPrepared(object sender, ASPxGridViewTableDataCellEventArgs e)
        //{
        //    string fieldName = e.DataColumn.FieldName;
        //    if (fieldName == "DeptID" || fieldName == "Transportor" || fieldName == "Checkor" || fieldName == "Reportor")
        //    {
        ...
        protected void ASPxGridViewMaster_InitNewRow(object sender, DevExpress.Web.Data.ASPxDataInitNewRowEventArgs e)
        {
            e.NewValues["TransportDate"] = DateTime.Now.Date;
            
        }

        protected void ASPxGridViewMaster_CellEditorInitialize(object sender, ASPxGridViewEditorEventArgs e)
        {
            if (e.Column.FieldName == "TransportDate")
            {
