...
{
    public partial class XDMJWPbgsh : Project.WebUi.App_Code.MyBasePage
    {
        ...
        private void SetUPControls()
        {
            ...
            {
                dt = db.ExecuteDataSet(CommandType.Text, "SELECT [ReportID], [DeptID], [Grade],[LabSite],  [LabSample], [LabObject], [Transportor], [TransportDate], [Reportor], [ReportDate], [Checkor] FROM [GRK_JYBG] WHERE ReportID = '" + reportID + "'").Tables[0];
            }
        ...
        protected void cp_Callback(object sender, DevExpress.Web.CallbackEventArgsBase e)
        {
            ...
            string updateReport = @"UPDATE GRK_JYBG SET DeptID =@DeptID, Grade =@Grade,LabSite =@LabSite, LabSample =@LabSample, 
