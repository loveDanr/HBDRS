<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TXSTXY.aspx.cs" Inherits="Project.WebUi.GRKHJJC.TXSTXY"  %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function grid_RowDblClick(s, e) {
            ...
            var nurl = "./TXSTXYbgsh.aspx?id=" + key;
...
<body>
    ...
    <div>
        ...
        <dx:ASPxGridView ID="ASPxGridViewMaster" runat="server" AutoGenerateColumns="False" Width="100%"  ClientInstanceName="gridMaster"
            ...
            OnHeaderFilterFillItems="ASPxGridViewMaster_HeaderFilterFillItems" OnStartRowEditing="ASPxGridViewMaster_StartRowEditing" onhtmlrowprepared="ASPxGridViewMaster_HtmlRowPrepared">
            ...
            <Columns>
                ...
                <dx:GridViewDataHyperLinkColumn Caption="打印报告单" VisibleIndex="1" FieldName="ReportID">
                    <PropertiesHyperLinkEdit Text="打印报告单" NavigateUrlFormatString="TXSTXYReport.aspx?id={0}"
                        Target="_blank">
                ...
                <dx:GridViewDataTextColumn Caption="标本" FieldName="LabSample" VisibleIndex="3">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn Caption="检验目的" FieldName="LabObject" 
                    VisibleIndex="6">
                    <EditFormSettings Visible="False" />
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataComboBoxColumn Caption="送检者" FieldName="Transportor" 
                    VisibleIndex="7">
                    <PropertiesComboBox ValueType="System.String" CallbackPageSize="10" EnableCallbackMode="true"
                ...
                <dx:GridViewDataComboBoxColumn Caption="报告者" FieldName="Reportor" 
                    VisibleIndex="9">
                    <PropertiesComboBox ValueType="System.String" CallbackPageSize="10" EnableCallbackMode="true"
                ...
                <dx:GridViewDataDateColumn Caption="报告日期" FieldName="ReportDate" 
                    VisibleIndex="10" SortIndex="1" SortOrder="Descending">
                    <PropertiesDateEdit DisplayFormatString="d">
                        <CalendarProperties ClearButtonText="清除" TodayButtonText="今天">
                        </CalendarProperties>
                    </PropertiesDateEdit>
                ...
                <dx:GridViewDataComboBoxColumn Caption="核对者" FieldName="Checkor" 
                    VisibleIndex="11">
                    <PropertiesComboBox ValueType="System.String" CallbackPageSize="10" EnableCallbackMode="true"
                ...
                <dx:GridViewDataTextColumn Caption="制备时间" FieldName="PreparationPeriod" VisibleIndex="4">
                </dx:GridViewDataTextColumn>
            </Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSourceReport" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConnString %>"
            SelectCommand="SELECT [ReportID], [DeptID], [LabSample],[PreparationPeriod], [LabObject], [Transportor], [TransportDate], [Reportor], [ReportDate], [Checkor] FROM [GRK_JYBG] WHERE ReportCategory='TXSTXY' AND TransportDate&gt;=@startDate AND TransportDate&lt;=@endDate "
            InsertCommand="INSERT INTO GRK_JYBG(DeptID, LabSample,PreparationPeriod, Transportor, TransportDate, Reportor, ReportDate, Checkor,ReportCategory) VALUES (@DeptID,@LabSample,@PreparationPeriod,@Transportor,@TransportDate,@Reportor,@ReportDate,@Checkor,'TXSTXY')"
            UpdateCommand="UPDATE GRK_JYBG SET DeptID =@DeptID, PreparationPeriod=@PreparationPeriod,LabSample =@LabSample, Transportor =@Transportor, TransportDate =@TransportDate, Reportor =@Reportor, ReportDate =@ReportDate, Checkor =@Checkor WHERE ReportID = @ReportID"
            DeleteCommand="DELETE GRK_JYBG WHERE ReportID=@ReportID">
            <InsertParameters>
                <asp:Parameter Name="DeptID" />
                <asp:Parameter Name="LabSample" />
                <asp:Parameter Name="PreparationPeriod" />
        ...
        <asp:SqlDataSource ID="SqlDataSourceJYItem" runat="server" ConnectionString="<%$ ConnectionStrings:LISConnectionString %>"
            SelectCommand="SELECT xmdh,xmmc,ISNULL(dyckz,'')+ISNULL(dw,'') AS zxbz FROM xm_info WHERE yq ='TXSTXY'">
        </asp:SqlDataSource>
