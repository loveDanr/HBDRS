<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="indexDept.aspx.cs" Inherits="Project.WebUi.GZCX.indexDept" %>
<%@ Register Assembly="DevExpress.Web.v15.2, Version=15.2.7.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web" TagPrefix="dx" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>财务箱-科室工资查询</title>
</head>
<body>
    ...
    <div>
        <table align="center">
            <tr>
                <td class="style1">
                    <asp:Label ID="Label1" runat="server" Text="科室工资查询" Font-Bold="True" Font-Size="13pt"></asp:Label>
                </td>
                <td>
                    <asp:Label ID="Label2" runat="server" Text="时间:"></asp:Label>
                </td>
                <td>
                    <%--<dx:ASPxDateEdit ID="ASPxDateEdit1" runat="server" DisplayFormatString="yyy-MM" 
                        EditFormat="Custom" EditFormatString="yyy-MM">
                        <CalendarProperties ShowClearButton="False" ShowDayHeaders="False" 
                            ShowTodayButton="False" ShowWeekNumbers="False">
                        </CalendarProperties>
                    </dx:ASPxDateEdit>--%>
                ...
                <td>
                    <dx:ASPxButton ID="ASPxButton2" runat="server" Text="导出Excel" OnClick="ASPxButton2_Click">
                    </dx:ASPxButton>
                </td>
                <td>
                    &nbsp;</td>
        ...
        <dx:ASPxGridView ID="ASPxGridView1" runat="server" KeyFieldName="人员编号" AutoGenerateColumns="False" 
            ...
            <Settings ShowFilterRow="True" ColumnMinWidth="70"  />
