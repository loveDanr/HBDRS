<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SHOUSGbgsh.aspx.cs" Inherits="Project.WebUi.GRKHJJC.SHOUSGbgsh"
     %>
...
<body>
    ...
    <div>
                        ...
                        <tr>
                            <td colspan="4">
                                ...
                                <asp:SqlDataSource ID="SqlDataSourceItem" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConnString %>"
                                    ...
                                    OnUpdating="SqlDataSourceItem_Updating" 
                                    OnDeleting="SqlDataSourceItem_Deleting">
                                    <SelectParameters>
        ...
        <asp:SqlDataSource ID="SqlDataSourceJYItem" runat="server" ConnectionString="<%$ ConnectionStrings:LISConnectionString %>"
            SelectCommand="SELECT xmdh,xmmc,ISNULL(dyckz,'')+ISNULL(dw,'') AS zxbz,ISNULL(cksx,0.0) as cksx,ISNULL(ckxx,0.0) as ckxx FROM xm_info WHERE yq ='SHOUSG'">
        </asp:SqlDataSource>
