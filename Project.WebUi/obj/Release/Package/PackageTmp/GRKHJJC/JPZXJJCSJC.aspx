<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JPZXJJCSJC.aspx.cs" Inherits="Project.WebUi.GRKHJJC.JPZXJJCSJC"  %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function grid_RowDblClick(s, e) {
            ...
            var nurl = "./JJCSJCbgsh.aspx?id=" + key;
...
<body>
    ...
    <div>
        ...
        <dx:ASPxGridView ID="ASPxGridViewMaster" runat="server" AutoGenerateColumns="False" Width="100%"  ClientInstanceName="gridMaster"
            ...
            <Columns>
                ...
                <dx:GridViewDataHyperLinkColumn Caption="打印报告单" VisibleIndex="1" FieldName="ReportID">
                    <PropertiesHyperLinkEdit Text="打印报告单" NavigateUrlFormatString="JJCSJCReport.aspx?id={0}"
                        Target="_blank">
                ...
                <dx:GridViewDataComboBoxColumn Caption="洁净度级别" FieldName="Grade" 
                    VisibleIndex="3">
            ...
            <Templates>
                <DetailRow>
                    <dx:ASPxGridView ID="ASPxGridViewDetails" runat="server" AutoGenerateColumns="False" Width="100%" 
                        ...
                        OnHtmlDataCellPrepared="ASPxGridViewDetails_HtmlDataCellPrepared" 
                        onload="ASPxGridViewDetails_Load">
                        <Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSourceReport" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConnString %>"
            SelectCommand="SELECT [ReportID], [DeptID], [LabSite], [Grade], [LabSample], [LabObject], [Transportor], [TransportDate], [Reportor], [ReportDate], [Checkor] FROM [GRK_JYBG] WHERE ReportCategory ='JPZX_JJCSJC' AND TransportDate&gt;=@startDate AND TransportDate&lt;=@endDate "
            InsertCommand="INSERT INTO GRK_JYBG(DeptID, LabSite, Grade, LabSample, Transportor, TransportDate, Reportor, ReportDate, Checkor,ReportCategory) VALUES (@DeptID,@LabSite,@Grade,@LabSample,@Transportor,@TransportDate,@Reportor,@ReportDate,@Checkor,'JPZX_JJCSJC')"
            UpdateCommand="UPDATE GRK_JYBG SET DeptID =@DeptID, LabSite =@LabSite, Grade =@Grade, LabSample =@LabSample, Transportor =@Transportor, TransportDate =@TransportDate, Reportor =@Reportor, ReportDate =@ReportDate, Checkor =@Checkor WHERE ReportID = @ReportID"
        ...
        <asp:SqlDataSource ID="SqlDataSourceJYItem" runat="server" ConnectionString="<%$ ConnectionStrings:LISConnectionString %>"
            SelectCommand="SELECT xmdh,xmmc,ISNULL(dyckz,'')+ISNULL(dw,'') AS zxbz FROM xm_info WHERE yq ='JJCSJC'">
        </asp:SqlDataSource>
