<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WTBMSG.aspx.cs" Inherits="Project.WebUi.GRKHJJC.WTBMSG"
     %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        //            var nurl = "WTBMSGbgsh.aspx?id=" + key;
        //            var mw = window.open(nurl, "bgxx_view");
        //            mw.focus();
        //        }
        function grid_RowDblClick(s, e) {
            var key = s.GetRowKey(e.visibleIndex);
...
<body>
    ...
    <div>
        ...
        <dx:ASPxGridView ID="ASPxGridViewMaster" runat="server" AutoGenerateColumns="False" Width="100%" 
            ...
            <Columns>
                ...
                <dx:GridViewDataHyperLinkColumn Caption="打印报告单" VisibleIndex="1" FieldName="ReportID">
                    <PropertiesHyperLinkEdit Text="打印报告单" NavigateUrlFormatString="WTBMSGReport.aspx?id={0}"
                        Target="_blank">
                ...
                <dx:GridViewDataComboBoxColumn Caption="环境类别" FieldName="Grade" VisibleIndex="4">
                ...
                <DetailRow>
                    <dx:ASPxGridView ID="ASPxGridViewDetails" runat="server" AutoGenerateColumns="False" Width="100%" 
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataComboBoxColumn Caption="环境分类" FieldName="ItemGrade" VisibleIndex="1">
                                <PropertiesComboBox ValueType="System.String" CallbackPageSize="10" EnableCallbackMode="true"
        ...
        <asp:SqlDataSource ID="SqlDataSourceReport" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConnString %>"
            SelectCommand="SELECT [ReportID], [DeptID], [LabSite],[Grade],[LabSample], [LabObject], [Transportor], [TransportDate], [Reportor], [ReportDate], [Checkor] FROM [GRK_JYBG] WHERE ReportCategory ='WTBMSG' AND TransportDate&gt;=@startDate AND TransportDate&lt;=@endDate "
            OnSelected="SqlDataSourceReport_Selected" InsertCommand="INSERT INTO GRK_JYBG(DeptID, LabSite,Grade, LabSample, Transportor, TransportDate, Reportor, ReportDate, Checkor,ReportCategory) VALUES (@DeptID,@LabSite,@Grade,@LabSample,@Transportor,@TransportDate,@Reportor,@ReportDate,@Checkor,'WTBMSG')"
        ...
        <asp:SqlDataSource ID="SqlDataSourceJYItem" runat="server" ConnectionString="<%$ ConnectionStrings:LISConnectionString %>"
            SelectCommand="SELECT xmdh,xmmc,ISNULL(dyckz,'')+ISNULL(dw,'') AS zxbz FROM xm_info WHERE yq ='WTBMSG'">
        </asp:SqlDataSource>
