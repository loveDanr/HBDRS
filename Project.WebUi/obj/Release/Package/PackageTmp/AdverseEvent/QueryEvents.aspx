<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QueryEvents.aspx.cs" Inherits="Project.WebUi.AdverseEvent.QueryEvents"
     %>
...
<body>
    ...
    <div>
        ...
        <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1"
            ...
            <Columns>
                <dx:GridViewCommandColumn Caption="操作" ShowDeleteButton="True" VisibleIndex="0">
                </dx:GridViewCommandColumn>
                <dx:GridViewDataTextColumn FieldName="baseEventID" Caption="事件ID" 
                    ReadOnly="True" VisibleIndex="3" SortIndex="0" SortOrder="Descending">
            ...
            <SettingsText ConfirmDelete="确定删除吗？"  CommandEdit="编辑" CommandDelete="删除" />
