<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HLYC.aspx.cs" Inherits="Project.WebUi.AdverseEvent.HLYC"
     %>
...
<body>
    ...
    <div style="margin: auto; width: 655px; text-align: center;">
        <h2 style="color: #4D4D4D;margin-top: 50px;margin-bottom: 20px;font-size: 24px;">
            护理压疮事件<dx:ASPxCheckBox ID="ASPxCheckBoxBL" runat="server" 
                Text="是否不良事件"
                style="float:right;" Checked="True" CheckState="Checked" >
        </dx:ASPxCheckBox>
        </h2>
    </div>
                ...
                <td colspan="4" style="border: 2px solid #a1a7ab;">
                    <table class="custom">
                        <tr>
                            ...
                            <td>
                                <dx:ASPxTextBox ID="ASPxTextBoxAreaDepth" runat="server" Width="131px" NullText="必须为整数或小数">
                                <ValidationSettings ErrorDisplayMode="None" Display="Dynamic" ValidationGroup="pageVG"
                                        SetFocusOnError="true">
                                        <RegularExpression ValidationExpression="\d+(.\d+)?" />
                                    </ValidationSettings>
                            ...
                            <td>
                                <dx:ASPxTextBox ID="ASPxTextBoxcm2" ClientInstanceName="txtArea" runat="server" Enabled="false" Width="170px" DisplayFormatString="f">
                                </dx:ASPxTextBox>
                            </td>
                        </tr>
                    </table>
