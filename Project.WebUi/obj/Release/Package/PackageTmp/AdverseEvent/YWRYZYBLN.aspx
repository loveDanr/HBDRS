<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YWRYZYBLN.aspx.cs" Inherits="Project.WebUi.AdverseEvent.YWRYZYBLN"
     %>
                ...
                <div class="container" id="main">
                    <div class="row">
                        ...
                        <div class="reportContent">
                            ...
                            <div id="section3" class="page-header" style="display:none;">
                                暴露源严重程度
                            </div>
                            <div style="margin-left: 60px;display:none;">
                                <table class="custom" cellspacing="10px">
                                    <tr>
                                        <td colspan="2" style="font-size: 14px; font-weight: bold; color: #4D4D4D; text-align: left;">
                                            来源患者资料
