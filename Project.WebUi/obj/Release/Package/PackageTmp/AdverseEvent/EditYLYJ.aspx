<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditYLYJ.aspx.cs" Inherits="Project.WebUi.AdverseEvent.EditYLYJ" %>
                ...
                <td colspan="3" style="border: 2px solid #a1a7ab;">
                    <dx:ASPxComboBox ID="ASPxComboBoxEType" runat="server"
                        ...
                        <Items>
                            ...
                            <dx:ListEditItem Text="非预期重返手术室或ICU" Value="非预期重返手术室或ICU" />
