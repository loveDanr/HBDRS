<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HLDDZC.aspx.cs" Inherits="Project.WebUi.AdverseEvent.HLDDZC"
     %>
    ...
    <div id="sectionDIV2" class="header-section">
        <table class="custom">
            ...
            <tr>
                ...
                <td class="td_right">
                    <dx:ASPxComboBox ID="ASPxComboBoxEType" runat="server" Width="100%" 
                        NullText="--请选择--" >
