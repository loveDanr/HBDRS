<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditYLFS.aspx.cs" Inherits="Project.WebUi.AdverseEvent.EditYLFS" %>
            ...
            <tr>
                ...
                <td colspan="3" style="border: 2px solid #a1a7ab;">
                    <dx:ASPxComboBox ID="ASPxComboBoxEType" runat="server"
                        ...
                        <Items>
                            <dx:ListEditItem Text="放射治疗中出现的脑水肿、窒息、长时间检查可能心梗或休克等意外事件" Value="放射治疗中出现的脑水肿、窒息、长时间检查可能心梗或休克等意外事件" />
			                <dx:ListEditItem Text="钡餐误吸入气管，小肠插管造影、钡灌肠造成肠道损伤，逆行插管造影尿道损伤，静脉肾孟造影压迫造成血管损伤，长时间检查可能心梗或休克等放射安全事件" Value="钡餐误吸入气管，小肠插管造影、钡灌肠造成肠道损伤，逆行插管造影尿道损伤，静脉肾孟造影压迫造成血管损伤，长时间检查可能心梗或休克等放射安全事件" />
                            <dx:ListEditItem Text="放射源过渡照射、误照射、放射源脱落" Value="放射源过渡照射、误照射、放射源脱落" />
                            <dx:ListEditItem Text="放射线泄露" Value="放射线泄露" />
                            <dx:ListEditItem Text="放射性物质沾染" Value="放射性物质沾染" />
                            <dx:ListEditItem Text="未行放射防护" Value="未行放射防护" />
                        </Items>
                    </dx:ASPxComboBox>
                </td>
            </tr>
