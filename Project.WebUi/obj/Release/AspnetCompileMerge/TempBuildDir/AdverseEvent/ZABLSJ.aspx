<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZABLSJ.aspx.cs" Inherits="Project.WebUi.AdverseEvent.ZABLSJ"
     %>
            ...
            <tr>
                ...
                <td colspan="3" style="border: 2px solid #a1a7ab;">
                    <dx:ASPxComboBox ID="ASPxComboBoxEType" runat="server" ValueType="System.String"
                        Width="100%">
                        <Items>
                            <dx:ListEditItem Text="婴幼儿、智障人士院内走失" Value="婴幼儿、智障人士院内走失" />
                            <dx:ListEditItem Text="自杀事件" Value="自杀事件" />
                            <dx:ListEditItem Text="群体性冲击医院" Value="群体性冲击医院" />
                            <dx:ListEditItem Text="盗窃事件" Value="盗窃事件" />
                            <dx:ListEditItem Text="失火" Value="失火" />
