<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditZYBL.aspx.cs" Inherits="Project.WebUi.AdverseEvent.EditZYBL" %>
                ...
                <div class="container" id="main">
                    <div class="row">
                        <div class="sidebar">
                            ...
                            <dx:ASPxButton ID="ASPxButton1" runat="server" Text="保存" AutoPostBack="false" Width="100px"
...
<RequiredField IsRequired="True"></RequiredField>
                            ...
                            <div style="margin-left: 60px;">
                                <table class="custom" cellspacing="10px">
                                    <tr>
                                        <td colspan="2" style="font-size: 14px; font-weight: bold; color: #4D4D4D4D4D4D; text-align: left;">
                                            （一）接触暴露
                                        </td>
                                    </tr>
                                    <tr>
...
<RequiredField IsRequired="True"></RequiredField>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <dx:ASPxTextBox ID="txtBLFS_JC_BW" runat="server" Width="170px" Height="25px">
                                                <ValidationSettings ErrorDisplayMode="None" Display="Dynamic" ValidationGroup="pageVG"
                                                    SetFocusOnError="true">
                                                    <RequiredField IsRequired="true" />
<RequiredField IsRequired="True"></RequiredField>
...
<RequiredField IsRequired="True"></RequiredField>
                                        ...
                                        <td>
                                            <dx:ASPxComboBox ID="cboBLFS_GLCZ" runat="server" ValueType="System.String" Height="25px"
                                                ...
                                                <Items>
                                                    ...
                                                    <dx:ListEditItem Text="锐器盒" Value="锐器盒" />
                            ...
                            <div id="section3Sub" style="margin-left: 60px;">
                                <table class="custom" cellspacing="10px">
                                    <tr>
                                        <td colspan="2" style="font-size: 14px; font-weight: bold; color: #4D4D4D; text-align: left;">
                                            来源患者资料
                            ...
                            <div style="margin-left: 60px;">
                                <table class="custom">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <dx:ASPxTimeEdit ID="teBLH_PF_CXSJ" runat="server" 
                            ...
                            <div style="margin-left: 60px;">
                                <table class="custom">
                                    ...
                                    <tr>
                                        <td>
                                            事件描述<br />(时间、地点、经过、暴露后处理)
                                        </td>
                                        <td>
                                            <dx:ASPxMemo ID="ASPxMemoDetails" runat="server" Height="71px" Width="500px">
                                            </dx:ASPxMemo>
                                        </td>
                                    </tr>
                                    <tr>
...
<ClientSideEvents NodeClick="OnNodeClick" CheckedChanged="OnCheckedChanged"></ClientSideEvents>
...
<RequiredField IsRequired="True"></RequiredField>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <dx:ASPxTextBox ID="txtrWorkYears" runat="server" Width="170px" Height="25px">
                                            </dx:ASPxTextBox>
                                        </td>
                                    </tr>
                                </table>
  ...
  <script type="text/javascript">
      ...
      if(GetQueryString("name")=="职业暴露-阴性")
      {
          document.getElementById("section3").style.display = "none";
          document.getElementById("section3Sub").style.display = "none";
      }
  </script>
</html>
