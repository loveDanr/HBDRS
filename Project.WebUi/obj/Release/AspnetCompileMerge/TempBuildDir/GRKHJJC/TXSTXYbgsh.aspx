<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TXSTXYbgsh.aspx.cs" Inherits="Project.WebUi.GRKHJJC.TXSTXYbgsh"  %>
...
<body>
    ...
    <div>
                ...
                <dx:PanelContent ID="PanelContent1" runat="server">
                    <table id="custom">
                        ...
                        <tr>
                            ...
                            <td>
                                <dx:ASPxTextBox ID="ASPxTextBoxPreparationPeriod" runat="server" Width="100%">
                                </dx:ASPxTextBox>
                            </td>
                            <td>
                                标本
        ...
        <asp:SqlDataSource ID="SqlDataSourceJYItem" runat="server" ConnectionString="<%$ ConnectionStrings:LISConnectionString %>"
            SelectCommand="SELECT xmdh,xmmc,ISNULL(dyckz,'')+ISNULL(dw,'') AS zxbz,ISNULL(cksx,0.0) as cksx,ISNULL(ckxx,0.0) as ckxx FROM xm_info WHERE yq ='TXSTXY'">
        </asp:SqlDataSource>
