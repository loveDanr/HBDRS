<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XDMJSG.aspx.cs" Inherits="Project.WebUi.GRKHJJC.XDMJSG"  %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function grid_RowDblClick(s, e) {
            ...
            var nurl = "./XDMJSGbgsh.aspx?id=" + key;
...
<body>
    ...
    <div>
        ...
        <dx:ASPxGridView ID="ASPxGridViewMaster" runat="server" AutoGenerateColumns="False" Width="100%"  ClientInstanceName="gridMaster"
            ...
            <Columns>
                ...
                <dx:GridViewDataHyperLinkColumn Caption="打印报告单" VisibleIndex="1" FieldName="ReportID">
                    <PropertiesHyperLinkEdit Text="打印报告单" NavigateUrlFormatString="XDMJSGReport.aspx?id={0}"
                        Target="_blank">
                ...
                <dx:GridViewDataComboBoxColumn Caption="采样类别" FieldName="Grade" 
                    VisibleIndex="3">
                ...
                <dx:GridViewDataTextColumn Caption="消毒剂名称" FieldName="DisSteMis" 
                    VisibleIndex="4">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn Caption="使用天数" FieldName="KeepTime" VisibleIndex="5">
                </dx:GridViewDataTextColumn>
        ...
        <asp:SqlDataSource ID="SqlDataSourceReport" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConnString %>"
            SelectCommand="SELECT [ReportID], [DeptID], [DisSteMis], [Grade], [KeepTime], [LabObject], [Transportor], [TransportDate], [Reportor], [ReportDate], [Checkor] FROM [GRK_JYBG] WHERE ReportCategory='XDMJSG' AND TransportDate&gt;=@startDate AND TransportDate&lt;=@endDate "
            InsertCommand="INSERT INTO GRK_JYBG(DeptID, DisSteMis, Grade, KeepTime, Transportor, TransportDate, Reportor, ReportDate, Checkor,ReportCategory) VALUES (@DeptID,@DisSteMis,@Grade,@KeepTime,@Transportor,@TransportDate,@Reportor,@ReportDate,@Checkor,'XDMJSG')"
            UpdateCommand="UPDATE GRK_JYBG SET DeptID =@DeptID, DisSteMis =@DisSteMis, Grade =@Grade, KeepTime =@KeepTime, Transportor =@Transportor, TransportDate =@TransportDate, Reportor =@Reportor, ReportDate =@ReportDate, Checkor =@Checkor WHERE ReportID = @ReportID"
            DeleteCommand="DELETE GRK_JYBG WHERE ReportID=@ReportID">
            <InsertParameters>
                <asp:Parameter Name="DeptID" />
                <asp:Parameter Name="DisSteMis" />
                <asp:Parameter Name="Grade" />
                <asp:Parameter Name="KeepTime" />
        ...
        <asp:SqlDataSource ID="SqlDataSourceJYItem" runat="server" ConnectionString="<%$ ConnectionStrings:LISConnectionString %>"
            SelectCommand="SELECT xmdh,xmmc,ISNULL(dyckz,'')+ISNULL(dw,'') AS zxbz FROM xm_info WHERE yq ='XDMJSG'">
        </asp:SqlDataSource>
