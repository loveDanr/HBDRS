<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NJXDSG.aspx.cs" Inherits="Project.WebUi.GRKHJJC.NJXDSG"  %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function grid_RowDblClick(s, e) {
            ...
            var nurl = "./NJXDSGbgsh.aspx?id=" + key;
...
<body>
    ...
    <div>
        ...
        <dx:ASPxGridView ID="ASPxGridViewMaster" runat="server" AutoGenerateColumns="False" Width="100%"  ClientInstanceName="gridMaster"
            ...
            <Columns>
                ...
                <dx:GridViewDataHyperLinkColumn Caption="打印报告单" VisibleIndex="1" FieldName="ReportID">
                    <PropertiesHyperLinkEdit Text="打印报告单" NavigateUrlFormatString="NJXDSGReport.aspx?id={0}"
                        Target="_blank">
                ...
                <dx:GridViewDataComboBoxColumn Caption="科别" FieldName="DeptID" VisibleIndex="1">
                ...
                <dx:GridViewDataComboBoxColumn Caption="采样类别" FieldName="Grade" VisibleIndex="2">
                ...
                <dx:GridViewDataTextColumn Caption="采集方法" FieldName="Means" VisibleIndex="3">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn Caption="标本" FieldName="LabSample" VisibleIndex="4">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn Caption="检验目的" FieldName="LabObject" VisibleIndex="5">
                    <EditFormSettings Visible="False" />
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataComboBoxColumn Caption="送检者" FieldName="Transportor" VisibleIndex="6">
                    <PropertiesComboBox ValueType="System.String" CallbackPageSize="10" EnableCallbackMode="true"
                ...
                <dx:GridViewDataDateColumn Caption="送检日期" FieldName="TransportDate" VisibleIndex="7">
                ...
                <dx:GridViewDataComboBoxColumn Caption="报告者" FieldName="Reportor" VisibleIndex="8">
                    <PropertiesComboBox ValueType="System.String" CallbackPageSize="10" EnableCallbackMode="true"
                ...
                <dx:GridViewDataDateColumn Caption="报告日期" FieldName="ReportDate" VisibleIndex="9" SortIndex="1" SortOrder="Descending">
                    <PropertiesDateEdit DisplayFormatString="d">
                        <CalendarProperties ClearButtonText="清除" TodayButtonText="今天">
                        </CalendarProperties>
                    </PropertiesDateEdit>
                ...
                <dx:GridViewDataComboBoxColumn Caption="核对者" FieldName="Checkor" VisibleIndex="10">
                    <PropertiesComboBox ValueType="System.String" CallbackPageSize="10" EnableCallbackMode="true"
        ...
        <asp:SqlDataSource ID="SqlDataSourceReport" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConnString %>"
            SelectCommand="SELECT [ReportID], [DeptID], [Means], [Grade], [LabSample], [LabObject], [Transportor], [TransportDate], [Reportor], [ReportDate], [Checkor] FROM [GRK_JYBG] WHERE ReportCategory='NJXDSG' AND TransportDate&gt;=@startDate AND TransportDate&lt;=@endDate "
            InsertCommand="INSERT INTO GRK_JYBG(DeptID, Means, Grade, LabSample, Transportor, TransportDate, Reportor, ReportDate, Checkor,ReportCategory) VALUES (@DeptID,@Means,@Grade,@LabSample,@Transportor,@TransportDate,@Reportor,@ReportDate,@Checkor,'NJXDSG')"
            UpdateCommand="UPDATE GRK_JYBG SET DeptID =@DeptID, Means =@Means, Grade =@Grade, LabSample =@LabSample, Transportor =@Transportor, TransportDate =@TransportDate, Reportor =@Reportor, ReportDate =@ReportDate, Checkor =@Checkor WHERE ReportID = @ReportID"
            DeleteCommand="DELETE GRK_JYBG WHERE ReportID=@ReportID">
            <InsertParameters>
                <asp:Parameter Name="DeptID" />
                <asp:Parameter Name="Means" />
