<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZLQXSG.aspx.cs" Inherits="Project.WebUi.GRKHJJC.ZLQXSG"  %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function grid_RowDblClick(s, e) {
            ...
            var nurl = "./ZLQXSGbgsh.aspx?id=" + key;
...
<body>
    ...
    <div>
        ...
        <dx:ASPxGridView ID="ASPxGridViewMaster" runat="server" AutoGenerateColumns="False" Width="100%"  ClientInstanceName="gridMaster"
            ...
            <Columns>
                ...
                <dx:GridViewDataHyperLinkColumn Caption="打印报告单" VisibleIndex="1" FieldName="ReportID">
                    <PropertiesHyperLinkEdit Text="打印报告单" NavigateUrlFormatString="ZLQXSGReport.aspx?id={0}"
                        Target="_blank">
                ...
                <dx:GridViewDataComboBoxColumn Caption="类别" FieldName="Grade" VisibleIndex="3">
                    <PropertiesComboBox ValueType="System.String" TextField="xmmc" DataSourceID="SqlDataSourceJYItem">
                        <%--<Items>
                            <dx:ListEditItem Text="I类" Value="I类" />
                            <dx:ListEditItem Text="II类" Value="II类" />
                            <dx:ListEditItem Text="III类" Value="III类" />
                            <dx:ListEditItem Text="IV类" Value="IV类" />
                        </Items>--%>
                    </PropertiesComboBox>
                </dx:GridViewDataComboBoxColumn>
                <dx:GridViewDataTextColumn Caption="采集位点" FieldName="Means" VisibleIndex="4">
                </dx:GridViewDataTextColumn>
        ...
        <asp:SqlDataSource ID="SqlDataSourceReport" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConnString %>"
            SelectCommand="SELECT [ReportID], [DeptID], [Means], [Grade], [LabSample], [LabObject], [Transportor], [TransportDate], [Reportor], [ReportDate], [Checkor] FROM [GRK_JYBG] WHERE ReportCategory='ZLQXSG' AND TransportDate&gt;=@startDate AND TransportDate&lt;=@endDate "
            InsertCommand="INSERT INTO GRK_JYBG(DeptID, Means, Grade, LabSample, Transportor, TransportDate, Reportor, ReportDate, Checkor,ReportCategory) VALUES (@DeptID,@Means,@Grade,@LabSample,@Transportor,@TransportDate,@Reportor,@ReportDate,@Checkor,'ZLQXSG')"
        ...
        <asp:SqlDataSource ID="SqlDataSourceJYItem" runat="server" ConnectionString="<%$ ConnectionStrings:LISConnectionString %>"
            SelectCommand="SELECT xmdh,xmmc,ISNULL(dyckz,'')+ISNULL(dw,'') AS zxbz FROM xm_info WHERE yq ='ZLQXSG'">
        </asp:SqlDataSource>
