<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HLZLQuery.aspx.cs" Inherits="Project.WebUi.HLZLREPORT.HLZLQuery" %>
    ...
    <div class="Main" align="center">
            <div class="top" style="width: 100%">
                <table width="100%" border="0" class="tftableTop">
                    <tr>
                        <td colspan="8" align="center" style="font-weight: bold; font-size: 28px; text-align: center;">国家护理质量数据查询
                    </td>
                </tr>
        ...
        <div class="bottom">
             <asp:GridView ID="GridView1" runat="server" CssClass="msgtable"  AutoGenerateColumns="False" EmptyDataText="空" OnDataBinding="GridView1_DataBinding" OnPageIndexChanging="GridView1_PageIndexChanging" OnRowCreated="GridView1_RowCreated" OnRowDataBound="GridView1_RowDataBound" OnRowDeleting="GridView1_RowDeleting" ShowFooter="True" ShowHeaderWhenEmpty="True" Font-Size="15px" >
                    <Columns>
