<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QTJJCSbgsh.aspx.cs" Inherits="Project.WebUi.GRKHJJC.QTJJCSbgsh"
     %>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSourceJYItem" runat="server" ConnectionString="<%$ ConnectionStrings:LISConnectionString %>"
            SelectCommand="SELECT xmdh,xmmc,ISNULL(dyckz,'')+ISNULL(dw,'') AS zxbz,ISNULL(cksx,0.0) as cksx,ISNULL(ckxx,0.0) as ckxx FROM xm_info WHERE yq ='QTJJCS'">
        </asp:SqlDataSource>
