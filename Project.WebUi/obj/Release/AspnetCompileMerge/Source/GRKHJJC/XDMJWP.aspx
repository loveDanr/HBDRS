<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XDMJWP.aspx.cs" Inherits="Project.WebUi.GRKHJJC.XDMJWP"  %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function grid_RowDblClick(s, e) {
            ...
            var nurl = "./XDMJWPbgsh.aspx?id=" + key;
        ...
        function OnCBtnC(s, e) {
            if (popupWin.GetContentIFrame().contentWindow.gvDetails != undefined)
...
<body>
    ...
    <div>
        ...
        <dx:ASPxGridView ID="ASPxGridViewMaster" runat="server" AutoGenerateColumns="False" Width="100%"  ClientInstanceName="gridMaster"
            KeyFieldName="ReportID" DataSourceID="SqlDataSourceReport" 
            OnHeaderFilterFillItems="ASPxGridViewMaster_HeaderFilterFillItems" OnStartRowEditing="ASPxGridViewMaster_StartRowEditing">
            ...
            <Columns>
                ...
                <dx:GridViewDataHyperLinkColumn Caption="打印报告单" VisibleIndex="1" FieldName="ReportID">
                    <PropertiesHyperLinkEdit Text="打印报告单" NavigateUrlFormatString="XDMJWPReport.aspx?id={0}"
                        Target="_blank">
                ...
                <dx:GridViewDataTextColumn Caption="检验目的" FieldName="LabObject" VisibleIndex="7">
                    <EditFormSettings Visible="False" />
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataComboBoxColumn Caption="送检者" FieldName="Transportor" VisibleIndex="8">
                    <PropertiesComboBox ValueType="System.String" TextField="yhdh" ValueField="yhxm"
                        DataSourceID="SqlDataSourceUser" AllowMouseWheel="False" CallbackPageSize="10"
                        ClientInstanceName="cbUserT"  DropDownStyle="DropDown"
                        EnableCallbackMode="True" FilterMinLength="2" IncrementalFilteringMode="StartsWith"
                ...
                <dx:GridViewDataDateColumn Caption="送检日期" FieldName="TransportDate" 
                    VisibleIndex="9" SortIndex="0" SortOrder="Ascending">
                ...
                <dx:GridViewDataComboBoxColumn Caption="报告者" FieldName="Reportor" VisibleIndex="10">
                    <PropertiesComboBox ValueType="System.String" CallbackPageSize="10" EnableCallbackMode="true"
                ...
                <dx:GridViewDataDateColumn Caption="报告日期" FieldName="ReportDate" VisibleIndex="11" SortIndex="1" SortOrder="Descending">
                    <PropertiesDateEdit DisplayFormatString="d">
                        <CalendarProperties ClearButtonText="清除" TodayButtonText="今天">
                        </CalendarProperties>
                        <ValidationSettings>
                ...
                <dx:GridViewDataComboBoxColumn Caption="核对者" FieldName="Checkor" VisibleIndex="12">
                    <PropertiesComboBox ValueType="System.String" CallbackPageSize="10" EnableCallbackMode="true"
                ...
                <dx:GridViewDataTextColumn Caption="标本" VisibleIndex="6" FieldName="LabSample">
                </dx:GridViewDataTextColumn>
            </Columns>
                ...
                <DetailRow>
                    <dx:ASPxGridView ID="ASPxGridViewDetails" runat="server" AutoGenerateColumns="False" Width="100%" 
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn Caption="执行标准" FieldName="Reference" VisibleIndex="3">
                            </dx:GridViewDataTextColumn>
                        </Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSourceReport" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConnString %>"
            SelectCommand="SELECT [ReportID], [DeptID], [LabSample], [LabObject], [Transportor], [TransportDate], [Reportor], [ReportDate], [Checkor] FROM [GRK_JYBG] WHERE ReportCategory='XDMJWP' AND TransportDate&gt;=@startDate AND TransportDate&lt;=@endDate "
            InsertCommand="INSERT INTO GRK_JYBG(DeptID, LabSample, Transportor, TransportDate, Reportor, ReportDate, Checkor,ReportCategory) VALUES (@DeptID,@LabSample,@Transportor,@TransportDate,@Reportor,@ReportDate,@Checkor,'XDMJWP')"
            UpdateCommand="UPDATE GRK_JYBG SET DeptID =@DeptID, LabSample =@LabSample,  Transportor =@Transportor, TransportDate =@TransportDate, Reportor =@Reportor, ReportDate =@ReportDate, Checkor =@Checkor WHERE ReportID = @ReportID"
        ...
        <asp:SqlDataSource ID="SqlDataSourceJYItem" runat="server" ConnectionString="<%$ ConnectionStrings:LISConnectionString %>"
            SelectCommand="SELECT xmdh,xmmc,ISNULL(dyckz,'')+ISNULL(dw,'') AS zxbz FROM xm_info WHERE yq ='XDMJWP'">
        </asp:SqlDataSource>
        <dx:ASPxPopupControl ID="ASPxPopupControl1" runat="server" ClientInstanceName="popupWin"
            CloseAction="CloseButton" HeaderText="编辑" Height="500px" Modal="True" PopupHorizontalAlign="WindowCenter"
            PopupVerticalAlign="WindowCenter" Width="550px">
            <ClientSideEvents CloseUp="OnCloseUp" CloseButtonClick="OnCBtnC" />
            <ContentCollection>
