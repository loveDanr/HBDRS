<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XDMJSGbgsh.aspx.cs" Inherits="Project.WebUi.GRKHJJC.XDMJSGbgsh"  %>
                ...
                <dx:PanelContent ID="PanelContent1" runat="server">
                    <table id="custom">
                        ...
                        <tr>
                            ...
                            <td>
                                <dx:ASPxTextBox ID="ASPxTextBoxDisSteMis" runat="server" Width="100%">
                                </dx:ASPxTextBox>
                            </td>
                            <td>
                                使用天数
