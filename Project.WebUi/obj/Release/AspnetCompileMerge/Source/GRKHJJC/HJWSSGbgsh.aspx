<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HJWSSGbgsh.aspx.cs" Inherits="Project.WebUi.GRKHJJC.HJWSSGbgsh" %>
...
<body>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSourceJYItem" runat="server" ConnectionString="<%$ ConnectionStrings:LISConnectionString %>"
            SelectCommand="SELECT xmdh,xmmc,ISNULL(dyckz,'')+ISNULL(dw,'') AS zxbz ,ISNULL(cksx,0.0) as cksx,ISNULL(ckxx,0.0) as ckxx FROM xm_info WHERE yq ='HJWSSG'">
        </asp:SqlDataSource>
