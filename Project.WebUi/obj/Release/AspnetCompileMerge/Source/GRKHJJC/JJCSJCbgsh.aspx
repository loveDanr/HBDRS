<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JJCSJCbgsh.aspx.cs" Inherits="Project.WebUi.GRKHJJC.JJCSJCbgsh"  %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OnSelectedIndexChanged(s, e) {
            ...
            //gvDetails.AttachEventToEditor(3, "ValueChanged", function (s, e) { this.OnEditorValueChanged(s, e); } .aspxBind(gvDetails.GetBatchEditHelper()));
            //gvDetails.GetEditor("Reference").OnValueChanged();
            var cob = s.GetSelectedItem();
            gvDetails.GetEditor("Reference").lastChangedValue = lcv;
            
            //
            //gvDetails.GetBatchEditHelper().ProcessServerInsertedRows(1);
            //gvDetails.GetBatchEditHelper().insertedValues[-1][3] = cob.GetColumnText("zxbz");
            //gvDetails.GetBatchEditHelper().SetClientValue(-1, 3, cob.GetColumnText("zxbz"), cob.GetColumnText("zxbz"));
            //gvDetails.FocusEditor(3);
            //gvDetails.GetBatchEditHelper().insertedValues[s.GetMainElement().parentNode.parentNode.parentNode.rowIndex * (-1)][3] = cob.GetColumnText("zxbz");
            //gvDetails.GetEditor("Reference").SetSelectedIndex(s.GetSelectedIndex());
            //zxbzCombo.SetSelectedIndex(s.GetSelectedIndex());
            //zxbzCombo.fireEvent('ValueChanged');
            //document.getElementById('dt_cell3').innerText = s.GetSelectedItem().GetColumnText("zxbz");
            //document.getElementsByName('cp$ASPxGridViewDetails$ctl24').item(0).nodeValue;
            //document.getElementById('cp$ASPxGridViewDetails$ctl24').innerText = s.GetSelectedItem().GetColumnText("zxbz");
            //document.getElementsByName('cp$ASPxGridViewDetails$ctl24').item(s.GetMainElement().parentNode.parentNode.parentNode.rowIndex - 1).innerText = s.GetSelectedItem().GetColumnText("zxbz");
            //zxbzTXT.SetText(s.GetSelectedItem().GetColumnText("zxbz"));
        ...
        function cboLostFocus(s, e) {
            //document.getElementById(s.name).innerText =s.GetText();
            //document.getElementById(s.name).outerText = s.GetText();
            //s.GetMainElement().innerText = s.GetText();
            s.GetInputElement().innerText = s.GetText();
        }
    </script>
    <style type="text/css">
        #custom
...
<body>
    ...
    <div>
                ...
                <dx:PanelContent ID="PanelContent1" runat="server">
                    <table id="custom">
                        <tr>
                            ...
                            <td>
                                <dx:ASPxComboBox ID="ASPxComboBoxGrade" runat="server" ValueType="System.String" Width="100%">
                                    <Items>
                        ...
                        <tr>
                            ...
                            <td>
                                <dx:ASPxComboBox ID="ASPxComboBoxSample" runat="server" ValueType="System.String" Width="100%"
                                    TextField="xmmc" ValueField="xmmc" TextFormatString="{0}" DisplayFormatString="{0}"
                                    DataSourceID="SqlDataSourceJYItem" NullText="--请选择--">
                                    <Columns>
                        ...
                        <tr>
                            ...
                            <td>
                                <dx:ASPxComboBox ID="ASPxComboBoxT" runat="server" ValueType="System.String" Width="100%" CallbackPageSize="10"
                                    ...
                                    <ClientSideEvents LostFocus="cboLostFocus" />
                                    <Columns>
                        ...
                        <tr>
                            <td colspan="4">
                                <dx:ASPxGridView ID="ASPxGridViewDetails" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <ClientSideEvents BatchEditConfirmShowing="gridBatchEditConfirmShowing"></ClientSideEvents>
                                    <Columns>
                                        ...
                                        <dx:GridViewDataTextColumn Caption="参考值" FieldName="Reference" ShowInCustomizationForm="True"
                                            VisibleIndex="3">
                                            <PropertiesTextEdit>
                        ...
                        <tr>
                            <td colspan="4" style="text-align: center;">
                                <dx:ASPxButton ID="ASPxButtonSubmit" runat="server" ClientInstanceName="ASPxButtonSubmit"
                                    ...
                                    <ClientSideEvents Click="OnSubmit"></ClientSideEvents>
                                </dx:ASPxButton>
                            </td>
                        </tr>
                    </table>
        ...
        <asp:SqlDataSource ID="SqlDataSourceJYItem" runat="server" ConnectionString="<%$ ConnectionStrings:LISConnectionString %>"
            SelectCommand="SELECT xmdh,xmmc,ISNULL(dyckz,'')+ISNULL(dw,'') AS zxbz,ISNULL(cksx,0.0) as cksx,ISNULL(ckxx,0.0) as ckxx FROM xm_info WHERE yq ='JJCSJC'">
        </asp:SqlDataSource>
