<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditYPBLFY.aspx.cs" Inherits="Project.WebUi.AdverseEvent.EditYPBLFY" %>
            ...
            <dx:PanelContent ID="PanelContent1" runat="server">
                ...
                <div id="sectionDIV6" class="header-section">
                    ...
                    <asp:SqlDataSource ID="SqlDataSourceMedi" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConnString %>"
                        ...
                        UpdateCommand="update AE_MedicationInfo SET MediCommonName =@MediCommonName, MediProductName=@MediProductName, Company=@Company, ProuductBatch=@ProuductBatch, ApprovalNumber=@ApprovalNumber,Reason=@Reason, Dosage=@Dosage, Frequency=@Frequency, Route=@Route,StartTime=@StartTime, WithSuspected=@WithSuspected,EndTime=@EndTime where MedicineID=@MedicineID" 
