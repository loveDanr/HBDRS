<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XZBLSJ.aspx.cs" Inherits="Project.WebUi.AdverseEvent.XZBLSJ"
     %>
...
<body>
        ...
        <table class="custom">
            ...
            <tr>
                ...
                <td colspan="3" style="border: 2px solid #a1a7ab;">
                    <dx:ASPxComboBox ID="ASPxComboBoxEType" runat="server" ValueType="System.String"
                        Width="100%">
                        <Items>
                            <dx:ListEditItem Text="重要文件/信件丢失、损坏、信息外漏" Value="重要文件/信件丢失、损坏、信息外漏" />
                            <dx:ListEditItem Text="办公印章丢失" Value="办公印章丢失" />
                            <dx:ListEditItem Text="重要岗位缺岗/漏岗" Value="重要岗位缺岗/漏岗" />
                            <dx:ListEditItem Text="院内通讯失联" Value="院内通讯失联" />
                            <dx:ListEditItem Text="电力故障" Value="电力故障" />
                            <dx:ListEditItem Text="泛水、管道故障" Value="泛水、管道故障" />
                            <dx:ListEditItem Text="电梯故障" Value="电梯故障" />
                            <dx:ListEditItem Text="供氧故障" Value="供氧故障" />
    ...
    <div id="sectionDIV3" class="header-section">
            ...
            <PanelCollection>
                <dx:PanelContent runat="server">
                    <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" ClientInstanceName="gridParty"
                        DataSourceID="SqlDataSourceParty" KeyFieldName="partyID;baseEventID" OnBatchUpdate="ASPxGridView1_BatchUpdate"
        ...
        <asp:SqlDataSource ID="SqlDataSourceParty" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConnString %>"
            ...
            OnInserting="SqlDataSourceParty_Inserting" OnUpdating="SqlDataSourceParty_Updating"
            OnInserted="SqlDataSourceParty_Inserted">
            <InsertParameters>
