<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditYYCW.aspx.cs" Inherits="Project.WebUi.AdverseEvent.EditYYCW" %>
                ...
                <div id="sectionDIV6" class="header-section">
                    <dx:ASPxGridView ID="ASPxGridView2" runat="server" AutoGenerateColumns="False" ClientInstanceName="gridMedi"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn Caption="药物通用名" ShowInCustomizationForm="True" VisibleIndex="1"
                            ...
                            <dx:GridViewDataTextColumn Caption="药品商用名称" ShowInCustomizationForm="True" VisibleIndex="2"
                                FieldName="MediProductName" Width="80px">
                                <PropertiesTextEdit>
                                    <InvalidStyle>
                                        <Border BorderColor="Red" BorderStyle="Solid" BorderWidth="1px" />
                                    </InvalidStyle>
                            ...
                            <dx:GridViewDataTextColumn Caption="分类" ShowInCustomizationForm="True" VisibleIndex="3"
                            ...
                            <dx:GridViewDataTextColumn Caption="剂型" ShowInCustomizationForm="True" VisibleIndex="4"
                                FieldName="Formula">
                                <PropertiesTextEdit>
                                    <InvalidStyle>
                                        <Border BorderColor="Red" BorderStyle="Solid" BorderWidth="1px" />
                            ...
                            <dx:GridViewDataTextColumn Caption="用法" ShowInCustomizationForm="True" VisibleIndex="5"
                                FieldName="Usage">
                                <PropertiesTextEdit>
                                    <InvalidStyle>
                                        <Border BorderColor="Red" BorderStyle="Solid" BorderWidth="1px" />
                            ...
                            <dx:GridViewDataTextColumn Caption="用量" ShowInCustomizationForm="True" VisibleIndex="6"
                                FieldName="Dosage">
                                <PropertiesTextEdit>
                                    <InvalidStyle>
                                        <Border BorderColor="Red" BorderStyle="Solid" BorderWidth="1px" />
                            ...
                            <dx:GridViewDataTextColumn Caption="服药频次" ShowInCustomizationForm="True" VisibleIndex="7"
                                FieldName="Frequency" Width="60px">
                                <PropertiesTextEdit>
                                    <InvalidStyle>
                                        <Border BorderColor="Red" BorderStyle="Solid" BorderWidth="1px" />
                                    </InvalidStyle>
                            ...
                            <dx:GridViewDataTextColumn Caption="疗程" ShowInCustomizationForm="True" VisibleIndex="8"
                                FieldName="TreatmentCourse">
                                <PropertiesTextEdit>
                                    <InvalidStyle>
                                        <Border BorderColor="Red" BorderStyle="Solid" BorderWidth="1px" />
                                    </InvalidStyle>
                            ...
                            <dx:GridViewDataTextColumn Caption="规格" ShowInCustomizationForm="True" VisibleIndex="9"
                                FieldName="MediSpec">
                                <PropertiesTextEdit>
                                    <InvalidStyle>
                                        <Border BorderColor="Red" BorderStyle="Solid" BorderWidth="1px" />
                            ...
                            <dx:GridViewDataTextColumn Caption="厂家" ShowInCustomizationForm="True" VisibleIndex="10"
                                FieldName="Company">
                                <PropertiesTextEdit>
                                    <InvalidStyle>
                                        <Border BorderColor="Red" BorderStyle="Solid" BorderWidth="1px" />
                            ...
                            <dx:GridViewDataTextColumn Caption="包装类型" ShowInCustomizationForm="True" VisibleIndex="11"
                                FieldName="PackageType" Width="70px">
                                <PropertiesTextEdit>
                                    <InvalidStyle>
                                        <Border BorderColor="Red" BorderStyle="Solid" BorderWidth="1px" />
                                    </InvalidStyle>
                    ...
                    <asp:SqlDataSource ID="SqlDataSourceMedi" runat="server" ConnectionString="<%$ ConnectionStrings:SQLConnString %>"
                        ...
                        InsertCommand="INSERT INTO AE_MedicationInfo(MediCommonName, MediProductName, Classification, Formula, Usage, Dosage, Frequency, TreatmentCourse, Company, PackageType, baseEventID, MediSpec) VALUES (@MediCommonName, @MediProductName, @Classification, @Formula, @Usage, @Dosage, @Frequency, @TreatmentCourse, @Company, @PackageType, @baseEventID, @MediSpec)"
                        UpdateCommand="update AE_MedicationInfo SET MediCommonName =@MediCommonName, MediProductName=@MediProductName, Classification=@Classification, Formula=@Formula, USAGE=@Usage, Dosage=@Dosage, Frequency=@Frequency, TreatmentCourse=@TreatmentCourse, Company=@Company, PackageType=@PackageType, MediSpec=@MediSpec  where MedicineID=@MedicineID" 
                        DeleteCommand="DELETE  dbo.AE_MedicationInfo WHERE MedicineID=@MedicineID"
                        >
                        <SelectParameters>
                ...
                <div id="sectionDIV7" class="header-section">
                    <table class="custom">
                        <tr>
                            ...
                            <td class="td_right">
                                <dx:ASPxTextBox ID="ASPxTextBoxCauseD" ClientInstanceName="txtReason" runat="server" Width="170px">
                            ...
                            <td class="td_right">
                                <dx:ASPxTimeEdit ID="ASPxTimeEditDeath" runat="server" ClientInstanceName="cited" Enabled="True" DisplayFormatString="yyyy-MM-dd HH:mm:ss"
                                    EditFormat="Custom" EditFormatString="yyyy-MM-dd HH:mm:ss">
                                </dx:ASPxTimeEdit>
                            </td>
                        </tr>
