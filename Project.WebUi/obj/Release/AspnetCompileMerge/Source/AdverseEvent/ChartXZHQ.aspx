<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChartXZHQ.aspx.cs" Inherits="Project.WebUi.AdverseEvent.ChartXZHQ" %>
...
WHERE  eventName = '行政后勤不良事件'
        AND reportTime &gt;= @startTime
        AND reportTime &lt;= @endTime 
        AND recordState=1
  GROUP BY SUBSTRING(eventGrade,1,CHARINDEX ( '—' ,eventGrade)-1)">
            <SelectParameters>
