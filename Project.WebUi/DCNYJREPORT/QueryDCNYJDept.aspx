...
<body>
    ...
    <div class="Main" align="center">
        ...
        <div class="bottom">
              ...
              <div style="float:left"><asp:GridView ID="GridViewOther" runat="server" CssClass="msgtable"  AutoGenerateColumns="False" EmptyDataText="空" ShowFooter="True" ShowHeaderWhenEmpty="True" Font-Size="15px" OnDataBinding="GridViewOther_DataBinding" OnRowDataBound="GridViewOther_RowDataBound">
                            <Columns>
